...
<nav class="flex items-center justify-end bg-white shadow px-4 py-3 mb-6 flex-shrink-0">
    <div class="relative">
    <button id="topbarAvatarBtn" aria-haspopup="true" aria-expanded="false" class="w-10 h-10 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center focus:outline-none pulse-affordance">
        ...
        <div id="topbarDropdown" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-50 ring-1 ring-black ring-opacity-5">
            ...
            <div class="p-2">
                <div class="grid grid-cols-1 gap-2">
                    <a href="<?= base_url('profile') ?>" class="block px-3 py-2 rounded hover:bg-gray-100">👤 Profile</a>
                    <a href="<?= base_url('settings') ?>" class="block px-3 py-2 rounded hover:bg-gray-100">⚙️ Settings</a>
                    <a href="<?= base_url('support') ?>" class="block px-3 py-2 rounded hover:bg-gray-100">🆘 Support</a>
                </div>
