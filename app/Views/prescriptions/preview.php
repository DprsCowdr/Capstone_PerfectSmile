...
<head>
    <meta charset="utf-8">
    <title>Prescription #<?= esc($prescription['id']) ?> - Preview</title>
...
<body>
    ...
    <div class="pdf-controls">
        <div class="controls-container">
            ...
            <div class="actions">
                <a href="<?= base_url('admin/prescriptions/show/' . $prescription['id']) ?>" class="btn btn-secondary">
                    ← Back to Prescription
                </a>
                <a href="<?= base_url('admin/prescriptions/download-file/' . $prescription['id']) ?>" class="btn btn-primary">
                    ⬇ Download PDF
                </a>
            </div>
        </div>
